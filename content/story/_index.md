...
<div id="timeline" class="timeline">
  ...
  <section class="timeline-period">
    <header class="timeline-header">2025</header>
    <section class="timeline-event">
      <h1>Tech Lead for Client Frameworks at Google</h1>
      <section>
    ...
    <section class="timeline-event">
      <h1>Part of the Angular Documentary</h1>
      <section>
        <img src="/images/story/angular-documentary.jpeg">
        <p>
