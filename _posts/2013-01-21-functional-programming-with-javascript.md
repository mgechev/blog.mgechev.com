...
<pre lang="JavaScript">function animate(property, duration, endCallback) {
    //Animation here...
...
<pre lang="JavaScript">$.get('http://example.com/test.json', function (data) {
...
<pre lang="JavaScript">/* From Asen Bozhilov's lz library */
lz.memo = function (fn) {
    var cache = {};
    return function () {
...
<pre lang="JavaScript">var timeline = (function () {
    var articles = [];
...
<pre lang="JavaScript">[1,2,3,4].map(function (a) {
    return a * 2;
});
//[2,4,6,8]
</pre>
...
<pre lang="JavaScript">function factorial(n) {
    if (n &lt;= 1) return 1;
...
<pre lang="JavaScript">/* Code by Douglas Crockford */
...
<pre lang="JavaScript">var monad = MONAD();
...
<pre lang="JavaScript">/* By Stoyan Stafanov */
...
<pre lang="JavaScript">function quadraticEquation(a, b, c) {
    var d = b * b - 4 * a * c,
        x1, x2;
...
<pre lang="JavaScript">var temp = schonfinkelize(quadraticEquation, 1);
...
<pre lang="JavaScript">var f = function (a, b, c) {
  console.log(this, arguments);
};</pre>

Now we apply bind to it:

<pre lang="JavaScript">var newF = f.bind(this, 1, 2);
newF(); //window, [1, 2]
...
<pre lang="JavaScript">factorial 0 = 1
...
<pre lang="JavaScript">var $ = fun.parameter,
    fact = fun(
        [0, function ()  { return 1; }],
